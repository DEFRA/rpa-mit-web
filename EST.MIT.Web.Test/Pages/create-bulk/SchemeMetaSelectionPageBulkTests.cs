...
using EST.MIT.Web.Pages.create_bulk.SchemeMetaSelection;
...
public class SchemeMetaSelectionPageBulkTests : TestContext
{
    ...
    public SchemeMetaSelectionPageBulkTests()
    {
