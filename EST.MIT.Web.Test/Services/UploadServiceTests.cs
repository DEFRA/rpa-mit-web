...
public class UploadServiceTests : TestContext
{
    ...
    public async Task UploadFileAsync_Returns_200()
    {
        ...
        var response = await uploadService.UploadFileAsync(fileMock.Object, routeFields.SchemeType, routeFields.Organisation, routeFields.PaymentType, routeFields.AccountType, "user","userName");
